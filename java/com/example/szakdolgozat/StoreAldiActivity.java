...
public class StoreAldiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_store_aldi);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter = new StoreAdapter(StoreAldiActivity.this, mProduct);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(StoreAldiActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void initializeMaps() {

        String iframe = "<iframe src=https://maps.google.com/maps?q=aldi&t=&z=9&ie=UTF8&iwloc=&output=embed width=600 height=450 frameborder=0 {overflow:hidden;background:none!important;height:600px;width:450px;}style=border:0</iframe>";
