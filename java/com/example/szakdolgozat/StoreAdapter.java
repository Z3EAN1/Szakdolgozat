...
public class StoreAdapter extends  RecyclerView.Adapter<StoreAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Product> mProduct;

    public StoreAdapter(Context context, List<Product> items) {
        this.mContext = context;
        this.mProduct = items;
    }

    @Override
    public StoreAdapter.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_list, parent, false);
        return new StoreAdapter.ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull StoreAdapter.ImageViewHolder holder, int position) {
